<?php
/*
*Template Name:  Page - LVC - Gỗ - fullpage scroll
*
*/
get_header();
                    ...
                    <section class="section shs-header-custom" data-anchor="banner">
                        <div class="shs-slide container-fluidd">
                            <div class="slider-content slide-page-new slide-single-blog">
                                <img class="bgr-img" src="<?= get_template_directory_uri() ?>/assets/images/bgr-pagetitle-02.jpg" style="width:100%;height: 100vh">
