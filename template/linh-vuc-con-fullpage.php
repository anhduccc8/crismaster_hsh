            ...
            <div class="container-fluiddd">
                <div class="row-custom" id="fullpage">
                    <section class="section" data-anchor="banner">
                        ...
                        <div class="shs-page-title bg-img-section height-100vh-160px min-height-450-mb" style="background-image: url('<?= get_template_directory_uri() ?>/assets/images/bgr-pagetitle-01.jpg')">
                            <div class="shs-slide">
